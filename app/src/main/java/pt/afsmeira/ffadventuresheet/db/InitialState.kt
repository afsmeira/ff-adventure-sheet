...
object InitialState {
    ...
    val stats: List<Stat> = listOf(
        ...
        Stat(name = "Day of the Week",               type = MULTI_OPT, possibleValues = Defined(listOf("Stormsday", "Moonsday", "Fireday", "Earthday", "Windsday", "Seaday", "Highday"))),
        Stat(name = "Medkit",                        type = INT),
        Stat(name = "Bonuses, Penalties and Curses", type = TEXT),
        Stat(name = "Libra - Goddess of Justice",    type = SINGLE_OPT, possibleValues = Defined(listOf("Revitalization", "Escape", "Removal of Curses and Diseases"))),
        
        // The Citadel of Chaos
        Stat(name = "Spells", type = MULTI_OPT_REPEAT, possibleValues = Defined(listOf("Creature Copy", "E.S.P.", "Fire", "Fool's Gold", "Illusion", "Levitation", "Luck", "Shielding", "Skill", "Stamina", "Strength", "Weakness"))),
        ...
        // Scorpion Swamp
        Stat(name = "Spell Gems and Spells", type = MULTI_OPT_REPEAT, possibleValues = Defined(listOf("Skill", "Stamina", "Luck", "Fire", "Ice", "Illusion", "Friendship", "Growth", "Bless", "Fear", "Withering", "Curse"))),
        
        // Space Assassin
        Stat(name = "Weapons",   type = MULTI_OPT_REPEAT, possibleValues = Defined(listOf("Electric Lash", "Assault Blaster", "Grenade", "Gravity Bomb"))),
        ...
        // Temple of Terror
        Stat(name = "Spells", type = MULTI_OPT, possibleValues = Defined(listOf("Open Door", "Creature Sleep", "Magic Arrow", "Language", "Read Symbols", "Light", "Fire", "Jump", "Detect Trap", "Create Water"))),
        ...
        Stat(name = "Super Power", type = SINGLE_OPT, possibleValues = Defined(listOf("Super Strength", "Psi-Powers", "Enhanced Technological Skill", "Energy Blast"))),
        ...
        Stat(name = "Special Skill", type = SINGLE_OPT, possibleValues = Defined(listOf("Kyujutsu", "Iaijutsu", "Karumijutsu", "Ni-to-Kenjutsu"))),
        
        // Robot Commando
        Stat(name = "Robot",             type = TEXT),
        Stat(name = "Speed",             type = SINGLE_OPT, possibleValues = Defined(listOf("Slow", "Medium", "Fast", "Very Fast"))),
        ...
        Stat(name = "Special Skills", type = MULTI_OPT, possibleValues = Defined(listOf("Climb", "Hide", "Pick Lock", "Pick Pocket", "Secret Signs", "Sneak", "Spot Hidden"))),
        
        // Chasms of Malice
        Stat(name = "Tabasha the Bazouk", type = TEXT),
        Stat(name = "Khuddam",            type = MULTI_OPT, possibleValues = Defined(listOf("Geshrak", "Gurskut", "Friankara", "Barkek", "Griffkek", "Churka", "Kahhrac"))),
        ...
        // Daggers of Darkness
        Stat(name = "Medallions", type = MULTI_OPT, possibleValues = Defined(listOf("Yigenik", "Uruz", "Bogomil", "Hulugu", "Korkut", "Kazilik"))),
        
        // Armies of Death
        Stat(name = "Soldiers",     type = TEXT),
        Stat(name = "Situation",    type = SINGLE_OPT, possibleValues = Defined(listOf("Superior", "Even", "Inferior"))),
        ...
        // Dead of Night
        Stat(name = "Talents",    type = MULTI_OPT, possibleValues = Defined(listOf("Banish Undead", "Darkveil", "Heal", "Holy Circle", "Meditation", "Sense Demon", "Speak Demon"))),
        Stat(name = "Holy Water", type = INT),
        Stat(name = "Evil",       type = INT),
        
        // Master of Chaos
        Stat(name = "Skills",    type = MULTI_OPT, possibleValues = Defined(listOf("Acute Hearing", "Animal Wisdom", "Blindsight", "Climbing", "Move Silently", "Tracking"))),
        ...
        // Moonrunner
        Stat(name = "Skills", type = MULTI_OPT, possibleValues = Defined(listOf("Acrobatics", "Climb", "Combat", "Con", "Disguise", "Lock Picking", "Sleight of Hand", "Sneak", "Tracking"))),
        ...
        Stat(name = "Advantages",    type = MULTI_OPT, possibleValues = Defined(listOf("Can't be surprised", "Can use any weapons", "Add 2 to attack strength vs. stone monsters", "Add 2 to skill when testing spot skill"))),
        Stat(name = "Disadvantages", type = MULTI_OPT, possibleValues = Defined(listOf("Can't wear plate mail", "No bonus to attack strength with chain mail", "Subtract 2 from attack strength with crossbow", "Can't use longbow or two-handed weapon", "Can't use metal armor, bow or two-handed weapon"))),
        
        // Knights of Doom
        Stat(name = "Special Skills", type = MULTI_OPT, possibleValues = Defined(listOf("Battle Tactics", "Ride", "Target", "Tracking", "Weapon", "Arcane Lore", "Banish Spirit", "Commune", "Holy Strike"))),
